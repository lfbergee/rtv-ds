...
export const CodeBlock = ({children, className, live, render}:{children: any, className: any, live: any, render: any}) => {
    ...
    return (
      <div style={{marginTop: '40px'}}>
        <LiveProvider
          ...
          scope={{mdx, PrimaryButton, SecondaryButton, TertiaryButton}}
        >
          <LivePreview />
          <details style={{backgroundColor: "var(--background-primary)", marginTop: "16px", borderRadius: "4px", maxWidth: " 750px"}}>
          <summary>
            Vis kode
          </summary>
            <LiveEditor  />
