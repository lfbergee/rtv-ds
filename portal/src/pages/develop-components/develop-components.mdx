...
Ny release lages ved å oppdatere versjonsnummeret i `shared-components/package.json` og for `@rikstv/shared-components` i `portal/package.json` og merge den til master, release til npm skjer automatisk.
