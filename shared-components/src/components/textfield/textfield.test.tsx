...
brands.forEach((brand) => {
  it(`Should have have working text field for ${brand}`, () => {
    ...
    cy.get("div").should("have.class", "rds-textfield").and("have.class", "username-input-class");
    cy.get("input").first().should("have.class", "rds-textfield-input");
    ...
    cy.get("label").first().should("have.class", "rds-textfield-label");

    cy.get("div").should("have.class", "rds-textfield").and("have.class", "password-input-class");
    cy.get("input").last().should("have.class", "rds-textfield-input");
    cy.get("input").last().should("have.attr", "name", "password");
    cy.get("input").last().should("have.attr", "placeholder", "Password");
    cy.get("input").last().should("have.attr", "type", "password");
    cy.get("label").last().should("have.class", "rds-textfield-label");
    cy.get("div")
